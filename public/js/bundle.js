    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          // Mostrar o erro completo para depuração
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addUser.js":[function(require,module,exports) {
"use strict";
...
var addUser = exports.addUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, address, country, nuit, role, contact, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Usuário criado com sucesso!');
          }
          _context.next = 11;
          break;
        case 7:
  ...
  return function addUser(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"getLoansByUser.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.rejectLoan = exports.getloans = exports.createLaon = exports.approveLoan = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var getloans = exports.getloans = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/loans?user=".concat(id),
            data: data
          });
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Hist\xF3rico carregado com sucesso!");
          }
          _context.next = 10;
          break;
        case 7:
  ...
  return function getloans(_x) {
    return _ref.apply(this, arguments);
  };
}();
var createLaon = exports.createLaon = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(price, paymentTerm, GuaranteesOffered) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            ...
            data: {
              ...
              GuaranteesOffered: GuaranteesOffered
            }
          });
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Empr\xE9stimo submetido com sucesso!");
          }
          _context2.next = 10;
          break;
        case 7:
  ...
  return function createLaon(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var approveLoan = exports.approveLoan = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "/api/v1/loans/loans/".concat(id, "/approve")
          });
        case 3:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Empréstimo aprovado com sucesso');
  ...
  return function approveLoan(_x5) {
    return _ref3.apply(this, arguments);
  };
}();
var rejectLoan = exports.rejectLoan = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "/api/v1/loans/loans/".concat(id, "/reject")
          });
        case 3:
          res = _context4.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Empréstimo rejeitado com sucesso');
            location.reload(); // Atualiza a página para refletir mudanças
          }
          _context4.next = 10;
          break;
  ...
  return function rejectLoan(_x6) {
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var payLoan = exports.payLoan = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(loanId) {
    var session, stripe;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://127.0.0.1:8000/api/v1/payments/checkout-session/".concat(loanId));
        case 3:
          session = _context.sent;
          console.log(session);

          // 2) Create checkout form + charge credit card
          stripe = Stripe('pk_live_51Pl9sxKTkV3tiowHgpAN5YgWblxRrN1SVimFyxz9crVlg25X7FQBK0LJyXQMKUhasDgfSm8NGrgJSPfWdP1kP9cg00USVFTZfT');
          _context.next = 8;
...
exports.updateSettings = exports.resetPasswordByUSer = exports.recoverPassword = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var recoverPassword = exports.recoverPassword = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Link de recuperação de senha enviado para o seu email!');
          }
          _context2.next = 10;
          break;
        case 7:
  ...
  return function recoverPassword(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
var resetPasswordByUSer = exports.resetPasswordByUSer = /*#__PURE__*/function () {
  ...
  return function resetPasswordByUSer(_x4, _x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
...
var _getLoansByUser = require("./getLoansByUser");
...
var resetPasswordForm = document.querySelector('.recover-password-form');
var logOutBtnV1 = document.querySelector('.nav__el--logout-v1');
var userDataForm = document.querySelector('.form-user-data');
var loanDataForm = document.querySelector('.form-loan-data');
var userAddDataForm = document.querySelector('.form-user-data-v1');
var userPasswordForm = document.querySelector('.form-user-password');
var userResetPasswordForm = document.querySelector('.reset-password-form');
var approveLoanForms = document.querySelector('.approve-loan-form');
var rejectLoanForms = document.querySelector('.reject-loan-form');
var btnPays = document.querySelectorAll('.pay-loan');
if (approveLoanForms) approveLoanForms.addEventListener('click', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          loanId = approveLoanForms.getAttribute('data-id');
          (0, _getLoansByUser.approveLoan)(loanId); // Chama a função passando o ID do empréstimo
        case 3:
        case "end":
          return _context.stop();
      }
...
if (rejectLoanForms) rejectLoanForms.addEventListener('click', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          e.preventDefault();
          loanId = rejectLoanForms.getAttribute('data-id');
          (0, _getLoansByUser.rejectLoan)(loanId); // Chama a função passando o ID do empréstimo
        case 3:
        case "end":
          return _context2.stop();
      }
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.getElementById('email').value;
    (0, _updateSettings.recoverPassword)(email);
  });
}
if (userResetPasswordForm) {
  userResetPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordConfirm').value;
    var token = document.getElementById('token').value;
    (0, _updateSettings.resetPasswordByUSer)(password, passwordConfirm, token);
  });
}
if (logOutBtn) logOutBtn.addEventListener('click', function (e) {
  (0, _login.logout)();
});
if (logOutBtnV1) logOutBtnV1.addEventListener('click', function (e) {
  (0, _login.logout)();
});
...
if (userAddDataForm) userAddDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  ...
  var password = document.getElementById('password').value;
  var passwordConfirm = document.getElementById('passwordConfirm').value;
  (0, _addUser.addUser)(name, email, address, country, nuit, role, contact, password, passwordConfirm);
});
if (loanDataForm) loanDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var price = document.getElementById('price').value;
  var paymentDeadline = document.getElementById('paymentDeadline').value;
  var GuaranteesOffered = document.getElementById('GuaranteesOffered').value;
  (0, _getLoansByUser.createLaon)(price, paymentDeadline, GuaranteesOffered);
});
